...
//         achievementUpdates['achievementsProgress.Power Collector'] = {
//           'current': newTotal,
//           'isUnlocked': newTotal >= 10,
//           'updatedAt': FieldValue.serverTimestamp(),
//         };
//       }

//       if (starActivations != null && starActivations >= 3) {
//         achievementUpdates['achievementsProgress.Invincible'] = {
//           'current': starActivations,
//           'isUnlocked': true,
//           'updatedAt': FieldValue.serverTimestamp(),
//         };
//       }
...
//         achievementUpdates['achievementsProgress.Heart Collector'] = {
//           'current': newTotal,
//           'isUnlocked': newTotal >= 5,
//           'updatedAt': FieldValue.serverTimestamp(),
//         };
//       }

//       if (reachedMaxLives == true) {
//         achievementUpdates['achievementsProgress.Maximum Life'] = {
//           'current': 5,
//           'isUnlocked': true,
//           'updatedAt': FieldValue.serverTimestamp(),
//         };
...
//         achievementUpdates['achievementsProgress.Combo Master'] = {
//           'current': consecutivePowerUps,
//           'isUnlocked': true,
//           'updatedAt': FieldValue.serverTimestamp(),
//         };
//       }
...
//           if (playedAt.isAfter(oneHourAgo)) gamesInLastHour++;
...
//           if (playedAt.isAfter(oneMonthAgo)) gamesInLastMonth++;
//         }
//       }
...
//       // 20 Games in 1 hour
//       achievementUpdates['achievementsProgress.20 Games'] = {
//         'current': gameStats['hour'],
//         'isUnlocked': (gameStats['hour'] ?? 0) >= 20,
//         'updatedAt': FieldValue.serverTimestamp(),
//       };

//       // 100 Games in 1 day
//       achievementUpdates['achievementsProgress.100 Games'] = {
//         'current': gameStats['day'],
//         'isUnlocked': (gameStats['day'] ?? 0) >= 100,
//         'updatedAt': FieldValue.serverTimestamp(),
//       };

//       // 1000 Games in 1 week
//       achievementUpdates['achievementsProgress.1000 Games'] = {
//         'current': gameStats['week'],
//         'isUnlocked': (gameStats['week'] ?? 0) >= 1000,
//         'updatedAt': FieldValue.serverTimestamp(),
//       };

//       // 25000 Games in 3 weeks
//       achievementUpdates['achievementsProgress.25000 Games'] = {
//         'current': gameStats['threeWeeks'],
//         'isUnlocked': (gameStats['threeWeeks'] ?? 0) >= 25000,
//         'updatedAt': FieldValue.serverTimestamp(),
//       };

//       // 60000 Games in 1 month
//       achievementUpdates['achievementsProgress.60000 Games'] = {
//         'current': gameStats['month'],
//         'isUnlocked': (gameStats['month'] ?? 0) >= 60000,
//         'updatedAt': FieldValue.serverTimestamp(),
//       };
